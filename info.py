...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '📂 <em>File Name</em>: <code>TP|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> \n\n╔═════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗\n\n🍿    𝙅𝙊𝙄𝙉 :- @RequestTP      🍿         \n\n╚════<a href='https://t.me/Pushpan_telegram'>ᵀᵉˡᵃᵍʳᵃᵐ ᴾᵘˢʰᵖᵃⁿ ════╝</a>')
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", '')
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", '🏷 <b>Query: {query}</b> \n‌IMDb Data:\n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 \n\n⚠️ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡʟʟ ᴀᴜᴛᴏᴍᴀᴛᴄʟʏ ᴅᴇʟᴇᴛᴇ ᴀꜰᴛᴇʀ 15 ᴍɴᴜᴛꜱ \n\n🔥ᴘᴏᴡᴇʀᴅ ʙʏ ᴛᴇʟᴀɢʀᴀᴍ_ᴘᴜꜱʜᴘᴀɴ')
